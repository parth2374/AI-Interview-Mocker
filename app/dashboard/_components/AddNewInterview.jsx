...
const AddNewInterview = () => {
    ...
    const onSubmit = async (e) => {
        ...
        const InputPrompt="Job Position: "+jobPosition+", Job Description: "+jobDesc+", Years of Experience: "+jobExperience+", Depends on the position, Job Description and Years of Experience give us "+process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT+" interview questions along with answers in JSON format. Give us question and answer as field on JSON"
                    ...
                    <form onSubmit={onSubmit}>
                        <div>
                            ...
                            <div className='mt-7 my-3'>
                                ...
                                <Input className='mt-2 mb-7' placeholder='Eg. Full Stack Developer' required onChange={(event) => setJobPosition(event.target.value)} />
                            </div>
                            <div className='my-3'>
                                <label>Job Description/Tech Stack (In Short)</label>
                                <Textarea className='mt-2 mb-7' required placeholder='Eg. React, Angular, NodeJs, MySql, etc' onChange={(event) => setJobDesc(event.target.value)} />
                            </div>
                            <div className='my-3'>
                                <label>Years of Experience</label>
                                <Input className='mt-2 mb-7' placeholder='Eg. 5' type='number' required max='50' onChange={(event) => setJobExperience(event.target.value)} />
                            </div>
                        </div>
